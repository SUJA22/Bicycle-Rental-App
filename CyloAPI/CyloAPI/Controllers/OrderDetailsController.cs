...
namespace CyloAPI.Controllers
{
    public class OrderDetailsController : ControllerBase
    {
        ...
        {
            string query = @"select * from dbo.order_details";
        ...
        public JsonResult Post(UserDetails user)
        {
            ...
            string query = @"insert into dbo.order_details values(
        ...
        public JsonResult Put(UserDetails user)
        {
            ...
            string query = @"update dbo.order_details set password=
                            '" + user.Password + @"'
        ...
        public JsonResult Delete(int id)
        {
            ...
            string query = @"delete from dbo.order_details where userId='" + id + @"'";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("BicycleAppCon");
            SqlDataReader myReader;
            using (SqlConnection myConn = new SqlConnection(sqlDataSource))
