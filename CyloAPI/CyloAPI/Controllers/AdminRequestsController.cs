...
namespace CyloAPI.Controllers
{
    public class AdminRequestsController : ControllerBase
    {
        ...
        public AdminRequestsController(IConfiguration config)
        {
        ...
        {
            string query = @"select * from dbo.admin_requests";
        ...
        public JsonResult Post(UserDetails user)
        {
            ...
            string query = @"insert into dbo.admin_requests values(
        ...
        public JsonResult Put(UserDetails user)
        {
            ...
            string query = @"update dbo.admin_requests set password=
                            '" + user.Password + @"'
        ...
        public JsonResult Delete(int id)
        {
            ...
            string query = @"delete from dbo.admin_requests where userId='" + id + @"'";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("BicycleAppCon");
            SqlDataReader myReader;
            using (SqlConnection myConn = new SqlConnection(sqlDataSource))
