...
namespace CyloAPI.Controllers
{
    ...
    public class UserAddressesController : ControllerBase
    {
        ...
        public UserAddressesController(IConfiguration config)
        {
        ...
        {
            string query = @"select * from dbo.user_address";
        ...
        public JsonResult Post(UserDetails user)
        {
            ...
            string query = @"insert into dbo.user_address values(
        ...
        public JsonResult Put(UserDetails user)
        {
            ...
            string query = @"update dbo.user_address set password=
                            '" + user.Password + @"'
        ...
        public JsonResult Delete(int id)
        {
            ...
            string query = @"delete from dbo.user_address where userId='" + id + @"'";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("BicycleAppCon");
            SqlDataReader myReader;
            using (SqlConnection myConn = new SqlConnection(sqlDataSource))
